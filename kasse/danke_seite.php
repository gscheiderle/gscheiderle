...
// http://localhost/kasse/danke_seite.php?kd_nr=11516&re_nr=10167&amt=1.00&cc=EUR&cm=11516&st=Completed&tx=9LT709038U0725310
...
echo "<a href='http://localhost/tcpdf/examples/pdf_rechnung_gscheiderle.php?re_nr=$_GET[re_nr]&kd_nr=$_GET[cm]&transaktionsnr=$_GET[tx]' target='_blanc'>QUITTIERTE RECHNUNG DRUCKEN<br>
...
$inhalt.="<a href='http://localhost/tcpdf/examples/pdf_rechnung_gscheiderle.php?re_nr=$_GET[re_nr]&kd_nr=$_GET[cm]&transaktionsnr=$_GET[tx]' target='_blanc'>RECHNUNG DRUCKEN UND/ODER PDF SPEICHERN</a><br>
<br>";
...
// $inhalt_1.="<a href='http://localhost/kasse/ipn_analyse.php?transaktionsnr=$transaktionsnr'>$transaktionsnr</a><br>
$inhalt_1.="<a href='http://localhost/kasse/ipn_analyse.php?transaktionsnr=$_GET[tx]'>IPN $_GET[tx]</a><br>
