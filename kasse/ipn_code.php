...
$inhalt.="<a href='https://www.gscheiderle.de/tcpdf/examples/pdf_rechnung_gscheiderle.php?re_nr=$_POST[invoice]&kd_nr=$_POST[custom]&transaktionsnr=$_POST[txn_id]' target='_blanc'>RECHNUNG DRUCKEN UND/ODER PDF SPEICHERN</a><br>
<br>";
...
$inhalt_1.="<a href='https://www.gscheiderle.de/kasse/ipn_analyse.php?transaktionsnr=$_POST[txn_id]'>IPN $_POST[txn_id]</a><br>
