...
$inhalt.="<a href='http://192.168.2.106/gscheiderle/tcpdf/examples/pdf_rechnung_gscheiderle.php?re_nr=$_POST[invoice]&kd_nr=$_POST[custom]&transaktionsnr=$_POST[txn_id]' target='_blanc'>RECHNUNG DRUCKEN UND/ODER PDF SPEICHERN</a><br>
<br>";
...
$inhalt_1.="<a href='http://192.168.2.106/gscheiderle/kasse/ipn_analyse.php?transaktionsnr=$_POST[txn_id]'>IPN $_POST[txn_id]</a><br>
