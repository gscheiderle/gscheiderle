...
<?php echo "<form action=\"versandteemails.php\" method=\"POST\">"; ?>
<?php
...
?>
  ...
  <table width="800px" height="500px" cellpadding="10" cellspacing="0" border="0"
...
<table width="800px" height="0px" cellpadding="10" cellspacing="0" bgcolor="#FFFFFF"
...
$suche_versand=mysqli_query($link,"select distinct datum, stichwort, zufall_id from email_texte order by datum desc");
...
<option value="newsletter@petra-$uwesack.de">newsletter@petra-$uwesack.de</option>
<option value="buchclub@petra-$uwesack.de">buchclub@petra-$uwesack.de</option>
<option value="21-Tage@petra-$uwesack.de">21-Tage@petra-$uwesack.de</option>
</select>
</td>
...
<td>
eMail-Betreff:<br>
<textarea rows="1" name="betreff" cols="35" 
tabindex="10"><?php echo htmlspecialchars(neuladen($betreff_db,$_POST['betreff'])); ?></textarea>
</td>
...
<input type="radio" name="briefanrede" value="privat">&nbsp;Pers&ouml;nlich:&nbsp;Liebe(r) Vorname"<br>
<input type="radio" name="briefanrede" value="offiziell">&nbsp;Gesch&auml;ftlich:&nbsp;Sehr geehrte(r) Frau(Herr) Nachname"<br>
<input type="radio" name="briefanrede" value="keine_anrede" checked>&nbsp;Keine Anrede !<br>
...
$jahr = date("Y"); 
 ?>                 
                  ...
                  <option value="2014">2014</option> <option value="2015">2015</option> <option value="2016">2016</option></select>&nbsp;
                                <select name="monat"> 
                ...
                <?php                 
                                $versand_termin.=$_POST['jahr'];
                                $versand_termin.="-";
                                $versand_termin.=$_POST['monat'];
                                $versand_termin.="-";
                                $versand_termin.=$_POST['tag'];
                                $versand_termin.=", ";
                                $versand_termin.=$_POST['stunde'];
                 ?>
...
$select_email=mysqli_query($link,"select kd_nr, geschlecht, name, vorname, email from $temp_tab_name where email = 'lphwfamily@gmail.com' or email = 'usnh2000@yahoo.de'");
...
$header.='Reply-To: $_POST[absender]' . "\r\n";
