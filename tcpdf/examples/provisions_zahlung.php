...
$select_re_su=mysqli_query($link," select * from abrechnungen where ueberweisung_nr = '$_GET[ueberweisung]' ");
while ( $result_re_su = mysqli_fetch_array( $select_re_su, MYSQLI_BOTH ) ) {
$re_datum=$result_re_su['re_datum'];
$netto=$result_re_su['netto'];
$mwst=$result_re_su['mwst'];
$brutto=$result_re_su['brutto'];
$bezahlt_db=$result_re_su['bezahlt'];
$datum_db=$result_re_su['datum'];
}     
...
$pdf->Write(0, 'P R O V I S I O N S - Z A H L U N G
...
<table border="0" cellpadding="2" cellspacing="2" nobr="true">
 <tr>
  <th colspan="4" align="left">Rechnung-Nr.: $_GET[ueberweisung]<br>
Kunden-Nr.: $_GET[kd_nr]<br>
Ueberweisungs-Datum: $datum_db<br>
  </th>
 </tr>
...
<tr>
   <td colspan="4" align="center">
    <br>
mit der Paypal-Transaktions-Nr.:<br>
$_GET[transaktionsnr]<br>
   </td>
 </tr>
...
$positionen
  ...
  <td align="right"><b>$netto</b></td>
 </tr>
 
 <tr>
  <td colspan="2"></td>
  <td align="right">MWSt. $mw_st %</td>
  <td align="right"><b>$mwst</b></td>
 </tr>
 
 <tr>
  <td colspan="2"></td>
  <td align="right" bgcolor="#dadada">Endbetrag &euro;</td>
  <td align="right" bgcolor="#dadada"><b>$brutto</b></td>
 </tr>
...
<br>
DANKE FUER DIE FREUNDLICHE MITARBEIT
<br>
</th>
</tr>
...
$pdf->Output('gscheiderle-PROVISION:_'.$_GET[ueberweisung].'_fuer_'.$name.'_'.$vorname.'.pdf', 'I');
