...
/**
 * URL path to tcpdf installation folder (http://192.168.2.106/tcpdf/).
 ...
 */
define ('PDF_HEADER_LOGO', 'gscheiderle_logo.png');
 ...
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'TCPDF Rechnungsformular');
