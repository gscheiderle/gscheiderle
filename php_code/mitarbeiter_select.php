...
if ( $anhalten == "" ) { echo "<h1>Es gibt nichts abzurechnen !<br>
								   <a href='http://localhost/gscheiderle/administrator/auswahl.php'>hier geht's weiter</a></h1>";
					    exit();
...
// Zeile, wie sie ausgegegeben wird
	...
	<a href='http://localhost/gscheiderle/kasse/zahlung_mitarbeiter.php?email=$email_adresse&ueberweisung=$neueuebnr' target='_blank'>$email_adresse</a></td></tr>";
