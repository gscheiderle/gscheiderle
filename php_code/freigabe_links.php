...
$freigabelink[]=("<a href='http://192.168.2.106/gscheiderle/tcpdf/examples/pdf_tips_gscheiderle.php?renr=$_GET[re_nr]&tip_nr=$result_links[tip_nr]' target='_blanc'>&nbsp;$freigabe_link&nbsp;</a>");	
	
	

/*echo "<a href='http://192.168.2.106/gscheiderle/tcpdf/examples/pdf_tips_gscheiderle.php?renr=$_GET[re_nr]&tip_nr=$result_links[tip_nr]' target='_blanc'>$font&nbsp;$freigabe_link&nbsp;</font></a>";
echo "<br>";  */  
